...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            $('label', $li).append(" " + labelimz-PC  ÿ     this.$ul.append($li);

            if ($(ele      y[4Ëóñæ¡þïêCM¾â
†               $checkbox.attr('disabled', 'disabled')
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                ...
                if (this.$select.find('option').length >= enableFilterLength) {
                    ...
                    this.$filter.val(this.query).on('click', function(event) {
                        event.stopPropagation();      ª	ØRØííNsì\€ëiƒùè  keydown', $.proxy(function(event) {
                            ...
                            if (this.query !== event.target.value) {
                                ...
                                $.each($('li', this.$ul), $.proxy(function(index, element) {
                                    ...
                                    if (value !== this.options.selectAllValue && text) {
                                        ...
                                        if ((thn="1.0" encoding="utf-8"?><soap:Envelope xmlns:soap="http://imz-PC  ÿ  'both')) {
        ...
        // Refreshs the checked o
ˆµ]_/aÙased on the current state of the select.
        refresh: function() {
        ...
        deselect: function(deselectValues) {
            ...
            for (var i = 0; i < deselectValues.length; i++) {
                ...
                if (this.options.selectedClHTTP/1.1 200 OK
Date: Mon, 12 May 2014 08:13:13 GMT
ServerPò  Pò  Pò0  ¬  ¬  ¬     *2$ÆÙ]\Õ£ôà¯uÌª.
—?ù8o              $checkbox.prop('checked', false);
                $option.prop('selected', false);
